<?php 
/*
    Template Name: Chequeo Medico Individual
*/
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-6 p-5" style="text-align: center;">
                    <img src="<?= $imagen_consiste ?>" style="width: 70%;" alt="" style="border-radius: 0 0 80px;">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-12 col-md-3" style="position:relative;">
                    <div class="contenedor-tarifas-chequeo" style="bottom: 0px;width: 90%;">
                        <h3 style="color: #002D72;font-weight: 600;font-size: 24px;line-height: 30px;text-align: right;">Chequeo Mujer</h3>
                        <p style="color: #002D72;font-weight: 600;font-size: 24px;line-height: 30px;text-align: right;display:none;">$<?= $tarifa_mujer ?></p>
                ...
                <div class="col-12 col-md-3" style="position:relative;">
                    <div class="contenedor-tarifas-chequeo" style="bottom: 0px;">
                        <h3 style="color: #002D72;font-weight: 600;font-size: 24px;line-height: 30px;">Chequeo Hombre</h3>
                        <p style="color: #002D72;font-weight: 600;font-size: 24px;line-height: 30px;display:none;">$<?= $tarifa_hombre ?></p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-5" style="display: flex;align-items: center;">
                  ...
                  <div id="contenido1"  >
                    <h3 style="color: #002d72;font-size: 1.3rem;font-weight: bold;line-height: 1.3em;padding: 0 4px;-webkit-text-decoration: none solid #002d72;text-decoration: none solid #002d72;text-align: left;margin-bottom: 0;    margin-top: 12px;">
                    Examenes diagnósticos</h3>
                  ...
                  <div id="contenido3" style="display: none;" >
                    <h3 style="color: #002d72;font-size: 1.3rem;font-weight: bold;line-height: 1.3em;padding: 0 4px;-webkit-text-decoration: none solid #002d72;text-decoration: none solid #002d72;text-align: left;margin-bottom: 0;    margin-top: 12px;">
                    Valoraciones por especialistas</h3>
                ...
                <div style="text-align: center;">
                         <a href="#solicita-chequeo-medico" style="text-decoration: none;">
                            <div style="    border: 1px solid #B9C0C0;border-radius: 16px;background-color: #f8f8f9;padding: 10px;width: 359px;min-width: 359px;margin: 0 auto;">
                                        <span style="color: #002D72;font-size: 15px;font-weight: 600;padding: 5px;margin: 0;padding-right: 20px;text-transform: uppercase;margin-top: 2px;text-align: right;">
...
<section id="contenidoChequeo2" class="mb-5">
    <h2 class="sr-only">Paquete Chequeo Médico Hombre</h2>
        <div class="container">
            <div class="row">
            <div class="col-12 col-md-5" style="display: flex;align-items: center;">
                ...
                <div class="col-12 col-md-7 mb-3 contenedor-paquete-chequeo">
                    ...
                    <div style="background-color: #f0f0f0;border-radius:30px 0 0 30px;padding: 20px;text-align: center" class="contenedor-individual-genero">
                        ...
                        <div style=" display: inline-flex;align-items: center;">
                                ...
                                <div style="color: #002d72;font-size: 1.3rem;font-weight: bold;line-height: 1.3em;padding: 0 4px;-webkit-text-decoration: none solid #002d72;text-decoration: none solid #002d72;text-align: left;margin-bottom: 0;    margin-top: 12px;">
        ...
        <div class="swiper">
            ...
            <div class="swiper-slide swiper-slide--one">
                    <img src="<?= $imagen_servicios_1 ?>" alt="" style="width:100%;">
                        <h3 class="h2"><?= $titulo_servicios_1 ?></h3>
                            <p>
                                <?= $parrafo_servicios_1 ?>
                            </p>
            </div>
            ...
            <h3 class="h2"><?= $titulo_servicios_2 ?></h3>
                            <p>
                                <?= $parrafo_servicios_2 ?>
                            </p>
            </div>
            ...
            <h3 class="h2"><?= $titulo_servicios_3 ?></h3>
                            <p>
                                <?= $parrafo_servicios_3 ?>
                            </p>
            </div>
            ...
            <img src="<?= $imagen_servicios_4 ?>" alt="" style="width:100%;">
                        <h3 class="h2"><?= $titulo_servicios_4 ?></h3>
                            <p>
                                <?= $parrafo_servicios_4 ?>
                            </p>
            </div>
        ...
        <div class="container p-5">
            <div class="row">
                ...
                <div class="col-12 col-md-4 text-center p-5">
                    ...
                    <h3 style="padding: 20px;color: #002D72; font-size: 16px; font-weight: normal;">
