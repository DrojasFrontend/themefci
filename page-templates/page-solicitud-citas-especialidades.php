<?php
/* 
Template Name: Plantilla | Solicitud Citas Especialidades
*/
        ...
        <div class="wrapper">
            <div class="seccionFormularioSolicitudCitas__contenido">
                <div class="seccionFormularioSolicitudCitas__titulo">
                    <h2 class="heading--64 color--002D72">Agenda tu cita en tu especialidad</h2>
                ...
                <div class="seccionFormularioSolicitudCitas__grid">
                    <div class="seccionFormularioSolicitudCitas__form">
                        <?php echo do_shortcode('[contact-form-7 id="4099b83" title="Formulario solicitud de citas - especialidades"]'); ?>
                    </div>
