...
$intro_txt = get_field('texto_intro');
$escuelas = get_field('escuelas');
$link_escuela = get_field('link_escuela');
$metodologia = get_field('intro_metodologia');
$metodologias = get_field('metodologias');
$titular_cursos = get_field('titular_cursos');
...
$prueba_escuela = get_field('prueba_escuela');
...
if ($query->have_posts()) : while ($query->have_posts()) : $query->the_post();
    ...
    $fecha_taller_presencial = get_field('fecha_taller_presencial');
    ...
    $publicaciones[$id_publicacion] = array(
        ...
        "ubicacion" => $ubicacion,
        "fecha_taller_presencial" => $fecha_taller_presencial,
...
<style>
    .boton-escuela{
        background: rgba(228, 0, 70, 1);text-decoration: none;border-radius: 18px 0px 18px 0px;font-size: 18px!important;
        color: #fff!important;font-weight: 400;text-align: center!important;width: 80%;
        max-width: 300px;
        min-width: 300px;
        margin-top: 10px;
    }
    ...
    .cardiou--container .intro .escuelas .escuela::after{
        border:none!important;
    }
    .cardiou--container .intro .escuelas .escuela h3{
        font-size: 18px!important;color: #fff!important;padding: 15px;margin: 0;font-weight: 600;
    }
    ...
    @media only screen and (max-width: 767px) {
            ...
            .cardiou--container .intro .escuelas .escuela{
...
<main class="cardiou--container">
    ...
    <section  class="intro">
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-5 intro-txt">
                    <?= $intro_txt ?>
                </div>
                <div class="col-12 col-md-7">
                    <div class="escuelas">
                        <?php foreach ($escuelas as $escuela): ?>
                            <div class="escuela">
                                <a class="boton-escuela" href="<?= $escuela["link_escuela"]?>">
    ...
    <section class="metodologia">
        <div class="container">
            ...
            <div class="metodologia--items">
                <div class="row justify-content-center">
                    <?php foreach ($metodologias as $metodologia): ?>
                        <div class="col-12 col-md-5">
                            <div class="items--content">
                                <div class="content--icon">
                                    <img src="<?= $metodologia["icono_metodologia"]["url"] ?>" alt="<?= $metodologia["icono_metodologia"]["alt"] ?>" class="img-fluid">
                                </div>
                                ...
                                <div class="card_content">
                                    <div class="card-info">
                                        <div class="curso-info">
                                            <div class="info-item">
                                                <div class="icon">
                                                    <img src="https://www.lacardio.org/wp-content/uploads/2023/11/icono-modalidad.png" alt="Modalidad" class="img-fluid">
                                                </div>
                                                <p><strong>Modalidad:</strong> <?= $curso["modalidad"] ?></p>
                                            </div>
                                            <div class="info-item">
                                                <div class="icon">
                                                    <img src="https://www.lacardio.org/wp-content/uploads/2023/11/icono-horario.png" alt="Intensidad Horaria" class="img-fluid">
                                                </div>
                                                <p><strong>Intensidad:</strong> <?= $curso["intensidad"] ?></p>
                                            </div>
                                            <div class="info-item">
                                                <div class="icon">
                                                    <img src="https://www.lacardio.org/wp-content/uploads/2023/11/icono-perfil-profesional.png" alt="Perfil Profesional" class="img-fluid">
                                                </div>
                                                <p><strong>Dirigido a:</strong> <?= $curso["perfil_profesional"] ?></p>
                                            </div>
                                            <div class="info-item">
                                                <div class="icon">
                                                    <img src="https://www.lacardio.org/wp-content/uploads/2023/11/icono-costo.png" alt="Costos" class="img-fluid">
                                                </div>
                                        ...
                                        <div class="curso-resumen">
                                            <p>
                                                <strong>Normativa:</strong> <?= $curso["normativa"] ?> <br>
                                                <strong>Característica:</strong> <?= $curso["caracteristica"] ?> <br>
                                                <strong>Contenidos:</strong> <?= $curso["contenidos"] ?> <br>
                                            </p>
                                        </div>
                                        <div class="curso-cta">
                                            <a href="<?= $curso["link_curso"]["url"] ?>" target="<?= $curso["link_curso"]["target"] ?>" class="btn"><?= $curso["link_curso"]["title"] ?></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
">
                        ...
                        <div class="educacontigeneral__cadaresult__content" style="border:none!important;">
                            ...
                            <div class="educacontigeneral__cadaresult__content__content" style="padding: 0 1rem;">
                                <div class="educacontigeneral__cadaresult__content__fecha">
                                    ...
                                    <div class="fecha">
                                    <b style="color: #002d72;font-size: 12px;">Fecha pronto pago:</b> <?= $cadaPublicacion["fecha_inicio"] ?><br>
                                    <b style="color: #002d72;font-size: 12px;">Fecha de inicio:</b> <?= $cadaPublicacion["ubicacion"] ?><br>
                                    <b style="color: #002d72;font-size: 12px;">Fecha taller presencial:</b> <?= $cadaPublicacion["fecha_taller_presencial"] ?>
                                    </div>
                                </div>
    ...
    <section  class="derechos_deberes">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2>Responsabilidades del Estudiante</h2>
                </div>
            </div>
            <div class="item mb-4">
                <div class="row">
