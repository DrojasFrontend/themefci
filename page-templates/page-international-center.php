<?php
    /*
        Template Name: international Center
    ...
    */
    ...
    .doctores-cardio-patias .swiper-slide {width: calc(100% / 4);height: auto;border-radius: 10px;display: flex;
        ...
        align-items: center;
        flex-wrap: nowrap;background-color: #ffffff;
    }
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    <div style="display: inline-flex; pt-3 pb-3">
                        ...
                        <h2 style="color: #002d72; font-size: 2rem; font-weight: bold; line-height: 1.3em; margin: 0; padding: 0; padding-top: 5px; text-transform: capitalize; border: none;">¿Who are we  ?</h2>
                    </div>
                    <?= $quienes_somos ?>    
            ...
            <div class="row">
                <div class="col-12 pt-3 pb-3">
                    <div style="display: inline-flex;">
                        <img decoding="async" style="height: 64px;width: auto;" src="https://www.lacardio.org/wp-content/uploads/2024/01/icono-corazon.png" alt="Icono Corazon ">
                        <h2 style="color: #002d72; font-size: 2rem; font-weight: bold; line-height: 1.3em; margin: 0; padding: 0; padding-top: 5px; text-transform: capitalize; border: none;">Our specialties</h2>
                    </div>
                </div>
            </div>
    </div>                 
                    ...
                    <div class="swiper-slide">
                        <a href="<?= $item_slider["link_slider"]?>" style="text-align: center;">
                            <img src="<?= $item_slider["imagen_slider"]?>" alt="" style="width: auto;height: 100px;">
                                <h3 style="font-size:26px;"><?= $item_slider["titulo_slider"]?></h3>
    ...
    <div class="container">
            <div class="row">
                <div class="col-12 pt-3 pb-3">
                    <div style="display: inline-flex;">
                        <img decoding="async" style="height: 64px;width: auto;" src="https://www.lacardio.org/wp-content/uploads/2024/01/icono-corazon.png" alt="Icono Corazon ">
                        <h2 style="color: #002d72; font-size: 2rem; font-weight: bold; line-height: 1.3em; margin: 0; padding: 0; padding-top: 5px; text-transform: capitalize; border: none;">Our Services and Added Value</h2>
                    </div>
                </div>
            </div>
    </div>   
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-6 p-3" >
                    ...
                    <div style="display: inline-flex;">
                        <img decoding="async" style="height: 64px;width: auto;" src="https://www.lacardio.org/wp-content/uploads/2024/01/icono-corazon.png" alt="Icono Corazon ">
                        <h2 style="color: #002d72; font-size: 2rem; font-weight: bold; line-height: 1.3em; margin: 0; padding: 0; padding-top: 5px; text-transform: capitalize; border: none;">Our Patients</h2>
                    </div>
                            ...
                            <div class="pacientes p-3">
                                ...
                                <p style="padding:20px;">
                                    <b style="color: #e6264e;">
                                        Name: </b><?= $item_pacientes["nombre_paciente"]?>
                                    <br>
                                    Country: <?= $item_pacientes["pais_paciente"]?><br>
                ...
                <div class="contenedor-galeria" style="padding-left: 20px;">
                        <div style="display: inline-flex; align-items: center;overflow: hidden;">
                            <h2 style="color: #002d72; font-size: 2rem; font-weight: bold; line-height: 1.3em; margin: 0; padding: 0; ; text-transform: capitalize; border: none;">Photo Gallery</h2>
                        <!-- <img decoding="async" style=" margin-left: 10px;" src="https://qa2.lacardio.org/wp-content/uploads/2024/03/linea.png">-->
                        </div>
                    ...
                    <div class="contenedor-noticias" style="padding-left: 20px;">
                        <div style="display: inline-flex; align-items: center;overflow: hidden;">
                            <h2 style="color: #002d72; font-size: 2rem; font-weight: bold; line-height: 1.3em; margin: 0; padding: 0; ; text-transform: capitalize; border: none;">News</h2>
                            <img decoding="async" style=" margin-left: 10px;" src="https://qa2.lacardio.org/wp-content/uploads/2024/03/linea.png">
                        </div>
                            <img src="https://www.lacardio.org/wp-content/uploads/2024/03/noticias.png" alt="">
                        <h3><b style="color: #e6264e;">Título</b></h3>
                        <p>xxxxxxxxxxx xxxxxxxxxxxxxxxxxx xxxxxxxxxxx xxxxxxxxxxxxxxxxxxxxxxx xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx   xxxxxxxxxxxxxxxxxxx xxxxxxxxxxxxxx</p>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 pt-3 pb-3">
                    <div style="display: inline-flex;">
                        <img decoding="async" style="height: 64px;width: auto;" src="https://www.lacardio.org/wp-content/uploads/2024/01/icono-corazon.png" alt="Icono Corazon ">
                        <h2 style="color: #002d72; font-size: 2rem; font-weight: bold; line-height: 1.3em; margin: 0; padding: 0; padding-top: 5px; text-transform: capitalize; border: none;">Patient Wall</h2>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 pt-3 pb-3">
                    <div style="display: inline-flex;">
                        <img decoding="async" style="height: 64px;width: auto;" src="https://www.lacardio.org/wp-content/uploads/2024/01/icono-corazon.png" alt="Icono Corazon ">
                        <h2 style="color: #002d72; font-size: 2rem; font-weight: bold; line-height: 1.3em; margin: 0; padding: 0; padding-top: 5px; text-transform: capitalize; border: none;">National and International Accreditations and Recognitions</h2>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 pt-3 pb-3">
                    <div style="display: inline-flex;">
                        <img decoding="async" style="height: 64px;width: auto;" src="https://www.lacardio.org/wp-content/uploads/2024/01/icono-corazon.png" alt="Icono Corazon ">
                        <h2 style="color: #002d72; font-size: 2rem; font-weight: bold; line-height: 1.3em; margin: 0; padding: 0; padding-top: 5px; text-transform: capitalize; border: none;">Some of Our Agreements</h2>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 pt-3 pb-3">
                    <div style="display: inline-flex;">
                        <img decoding="async" style="height: 64px;width: auto;" src="https://www.lacardio.org/wp-content/uploads/2024/01/icono-corazon.png" alt="Icono Corazon ">
                        <h2 style="color: #002d72; font-size: 2rem; font-weight: bold; line-height: 1.3em; margin: 0; padding: 0; padding-top: 5px; text-transform: capitalize; border: none;">Contact us </h2>
                    </div>
                </div>

                <div class="col-12 col-md-6">
                    <?= do_shortcode('[contact-form-7 id="e745bf0" title="international Center - Proceso inscripción"]') ?>
                </div>     
                ...
                <div class="accordion accordion-flush" id="accordionFlushExample" style="background-color: #d3e7f2;">
                    ...
                    <div class="accordion-item">
                        ...
                        <img src="https://qa2.lacardio.org/wp-content/uploads/2024/01/comunicar-min.png" alt="" style="height: 50px;background-color: #d3e7f2;margin-right: 10px;">    
                        Contact
                        </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        ...
                        <img src="https://www.lacardio.org/wp-content/uploads/2024/01/hotel-min.png" alt="" style="height: 50px;background-color: #d3e7f2;margin-right: 10px;">    
                    ...
                    <div class="accordion-item">
                        ...
                        <img src="https://qa2.lacardio.org/wp-content/uploads/2024/03/2.png" alt="" style="height: 50px;background-color: #d3e7f2;margin-right: 10px;">    
                    ...
                    <div class="accordion-item">
                        ...
                        <img src="https://qa2.lacardio.org/wp-content/uploads/2024/01/apoyo-min.png" alt="" style="height: 50px;background-color: #d3e7f2;margin-right: 10px;">  
                        FAQs
                        </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        ...
                        <img src="https://qa2.lacardio.org/wp-content/uploads/2024/01/metodo-de-pago-min.png" alt="" style="height: 50px;margin-right: 10px;">
                        Payment Methods
                        </button>
                        </h2>
