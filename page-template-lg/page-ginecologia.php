<?php
/* 
Template Name: Plantilla Especialidad | Ginecologia
*/ 
...
<?php endif; ?>
    ...
    <?php if($mostrar_texto_imagen_cta_2) : ?>
      <!-- Texto Imagen 2 -->
        <?php get_template_part('template-parts/especialidades/seccion', 'texto-imagen-cta-2', array('class' => 'paginaGinecologia'));?>
      <!-- Fin Texto Imagen 2 -->
    <?php endif; ?>
    ...
    <?php if($mostrar_experto) : ?>
      <!-- Experto -->
        <?php get_template_part('template-parts/especialidades/seccion', 'expertos', array("class" => ""));?>
      <!-- Fin Experto -->
    <?php endif; ?>
