<?php
/* 
Template Name: Plantilla Especialidad | Cardiología-Clínica-pediátrica
*/ 
...
<?php endif; ?>
    ...
    <?php if($mostrar_imagen_texto_cta_invertido) : ?>
      <!-- Imagen Texto CTA -->
        <?php get_template_part('template-parts/especialidades/seccion', 'imagen-texto-cta_invertido', array('class' =>'paginaCardiologiaClinicaPediatrica'));?>
      <!-- Fin Imagen Texto CTA -->
    <?php endif; ?>
    ...
    <?php if($mostrar_texto_desc_banner) : ?>
      <!-- Texto Descripcion Banner -->
        <?php get_template_part('template-parts/especialidades/seccion', 'texto-desc-banner', array('class' =>'paginaCardiologiaClinicaPediatrica'));?>
    ...
    <?php if($mostrar_items_iconos) : ?>
      <!-- Items Iconos -->
        <?php get_template_part('template-parts/especialidades/seccion', 'items-iconos', array('class' =>'paginaCardiologiaClinicaPediatrica'));?>
      <!-- Fin Items Iconos -->
    <?php endif; ?>
