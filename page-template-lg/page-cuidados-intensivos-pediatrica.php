<?php
/* 
Template Name: Plantilla Especialidad | Cuidados Intensivos - Pediatrica
*/ 
...
<?php endif; ?>
    ...
    <?php if($mostrar_hero) : ?>
      <!-- Hero -->
        <?php get_template_part('template-parts/especialidades/seccion', 'hero', array('class' => 'paginaUCIPediatrica') );?>
      <!-- Fin Hero -->
    <?php endif; ?>
    ...
    <?php if($mostrar_texto_desc_banner) : ?>
      <!-- Texto Descripcion Banner -->
        <?php get_template_part('template-parts/especialidades/seccion', 'texto-desc-banner', array('class' =>'paginaUCIPediatrica'));?>
    ...
    <?php 
      get_template_part('template-parts/especialidades/seccion', 'tab-tarjeta-texto-imagen', 
        array(
          'class' => 'paginaUCIPediatrica',
          'active' => 'UCI Pediatrica',
