<?php
/* 
Template Name: Plantilla Especialidad | Otorrino
*/ 
...
<?php endif; ?>
    ...
    <?php if($mostrar_hero) : ?>
      <!-- Hero -->
        <?php get_template_part('template-parts/especialidades/seccion', 'hero', array('class' => 'paginaOtorrino') );?>
      <!-- Fin Hero -->
    <?php endif; ?>
    ...
    <?php if($mostrar_bloque_texto) : ?>
      <!-- Bloque Texto -->
      <?php get_template_part('template-parts/especialidades/seccion', 'bloque-texto', array('class' => 'paginaOtorrino') );?>
      <!-- Fin Bloque Texto -->
    <?php endif; ?>
    ...
    <?php if($mostrar_experto) : ?>
      <!-- Experto -->
        <?php get_template_part('template-parts/especialidades/seccion', 'expertos', array("class" => "marginTop paginaOtorrino"));?>
      <!-- Fin Experto -->
    <?php endif; ?>
