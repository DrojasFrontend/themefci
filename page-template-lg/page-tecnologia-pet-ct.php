<?php
/* 
Template Name: Plantilla Especialidad | Tecnologia PET CT
*/ 
...
<?php endif; ?>
    ...
    <?php if($mostrar_hero) : ?>
      <!-- Hero -->
        <?php get_template_part('template-parts/especialidades/seccion', 'hero', array('class' => 'paginaTecnologiaPetCt') );?>
      <!-- Fin Hero -->
    <?php endif; ?>
...
<?php endif; ?>
    ...
    <?php if($mostrar_lista_numerada) : ?>
      <!-- Lista Numerada -->
        <?php get_template_part('template-parts/especialidades/seccion', 'lista-numerada', array('class' => 'paginaTecnologiaPetCt'));?>
      <!-- Fin Lista Numerada -->
    <?php endif; ?>
