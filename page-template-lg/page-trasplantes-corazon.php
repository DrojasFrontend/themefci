<?php
/**
 * Template Name: Plantilla Trasplantes | Corazon
 * 
 * @package FCITheme
...
<?php endif; ?>
    ...
    <?php if ($mostrar_tarjetas_carusel) : ?>        
      <!-- Tarjetas Carusel -->    
      <?php get_template_part('template-parts/trasplante/seccion', 'tarjetas-carusel', array('class' => 'paginaCorazon')); ?>        
    ...
    <?php if ($mostrar_imagen_cta) : ?>        
      <!-- Imagen CTA -->      
      <?php get_template_part('template-parts/trasplante/seccion', 'imagen-cta', array('class' => 'paginaCorazon')); ?>        
      <!-- Fin Imagen CTA -->
    <?php endif; ?>    
    ...
    <?php if ($mostrar_soluciones) : ?>        
      <!-- Soluciones -->    
      <?php get_template_part('template-parts/trasplante/seccion', 'soluciones', array('class' => 'paginaCorazon')); ?>        
      <!-- Fin Soluciones -->
    <?php endif; ?>    
    ...
    <?php if ($mostrar_videos) : ?>        
      <!-- Videos -->    
      <?php get_template_part('template-parts/trasplante/seccion', 'videos', array('class' => 'paginaCorazon')); ?>        
      <!-- Fin Videos -->
    <?php endif; ?>
