<?php
/* 
Template Name: Plantilla Especialidad | Gastroenterología
*/ 
...
<?php endif; ?>
    ...
    <?php if($mostrar_targetas_grid) : ?>
      <!-- Targetas Grid -->
        <?php get_template_part('template-parts/especialidades/seccion', 'targetas-grid', array("class" => "paginaFallaCardia"));?>
      <!-- Fin Targetas Grid -->
    <?php endif; ?>
