...
<?php endif; ?>
    ...
    <!-- Texto Imagen -->
      <?php get_template_part('template-parts/especialidades/seccion', 'texto-imagen-cta', array("class" => "paginaSpect paddingBottom"));?>
    <!-- Fin Texto Imagen -->
    <?php endif; ?>
    ...
    <!-- Texto Imagen Fondo -->
      <?php get_template_part('template-parts/especialidades/seccion', 'texto-imagen-fondo-cta', array("class" => "paginaSpect paddingBottom"));?>
