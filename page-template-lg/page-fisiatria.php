<?php
/* 
Template Name: Plantilla Especialidad | Fisiatría
*/ 
...
<?php endif; ?>
    ...
    <?php if($mostrar_texto_imagen_cta) : ?>
      <!-- Texto Imagen CTA -->
        <?php get_template_part('template-parts/especialidades/seccion', 'texto-imagen-cta', array('class' =>'paginaFisiatria'));?>
