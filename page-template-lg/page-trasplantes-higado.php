<?php
/**
 * Template Name: Plantilla Trasplantes | Higado
 * 
 * @package FCITheme
...
<?php endif; ?>
  ...
  <?php if ($mostrar_texto_imagen) : ?>        
    <!-- Texto Imagen -->    
    <?php get_template_part('template-parts/trasplante/seccion', 'texto-imagen', array('class' => 'paginaHigado')); ?>         
    <!-- Fin Texto Imagen -->
  <?php endif; ?>    
  ...
  <?php if ($mostrar_tarjetas_carusel) : ?>        
    <!-- Tarjetas Carusel -->    
    <?php get_template_part('template-parts/trasplante/seccion', 'tarjetas-carusel', array('class' => 'paginaHigado')); ?>        
  ...
  <?php if ($mostrar_imagen_cta) : ?>        
    <!-- Imagen CTA -->      
    <?php get_template_part('template-parts/trasplante/seccion', 'imagen-cta', array('class' => 'paginaHigado')); ?>        
    <!-- Fin Imagen CTA -->
  <?php endif; ?>    
