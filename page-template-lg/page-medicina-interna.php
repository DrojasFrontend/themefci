<?php
/* 
Template Name: Plantilla Especialidad | Medicina Interna
*/ 
...
<!-- CONTENIDO -->
  <main class="paginaEtapaExpecialidades">
    <?php if($mostrar_hero) : ?>
      <!-- Hero -->
        <?php get_template_part('template-parts/especialidades/seccion', 'hero', array('class' => 'paginaCirugiaTorax') );?>
      <!-- Fin Hero -->
    <?php endif; ?>
    ...
    <?php if($mostrar_items_iconos) : ?>
      <!-- Items Iconos -->
        <?php get_template_part('template-parts/especialidades/seccion', 'items-iconos', array('class' => 'paginaMedicinaNuclear'));?>
      <!-- Fin Items Iconos -->
    <?php endif; ?>

    <?php if($mostrar_texto_imagen_cta_2) : ?>
      <!-- Texto Imagen 2 -->
        <?php get_template_part('template-parts/especialidades/seccion', 'texto-imagen-cta-2', array('class' => 'paginaMedicinaNuclear'));?>
      <!-- Fin Texto Imagen 2 -->
    <?php endif; ?>
