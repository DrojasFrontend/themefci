<?php
/* 
Template Name: Plantilla Especialidad | Cirugia General
*/ 
...
<?php endif; ?>
    ...
    <?php if($mostrar_hero) : ?>
      <!-- Hero -->
        <?php get_template_part('template-parts/especialidades/seccion', 'hero', array('class' => 'paginaCirugiaGeneral') );?>
      <!-- Fin Hero -->
    <?php endif; ?>
    ...
    <?php endif; ?>
     ...
     <?php if($mostrar_imagen_texto_cta) : ?>
      <!-- Imagen Texto CTA -->
        <?php get_template_part('template-parts/especialidades/seccion', 'imagen-texto-cta' );?>
      <!-- Fin Imagen Texto CTA -->
    <?php endif; ?>

    <?php if($mostrar_imagen_texto_cta_invertido) : ?>
      <!-- Imagen Texto CTA -->
        <?php get_template_part('template-parts/especialidades/seccion', 'imagen-texto-cta_invertido');?>
      <!-- Fin Imagen Texto CTA -->
    <?php endif; ?>
    ...
    <?php if($mostrar_lista_numerada) : ?>
      <!-- Lista Numerada -->
        <?php get_template_part('template-parts/especialidades/seccion', 'lista-numerada',  array('class' => 'paginaCirugiaGeneral') );?>
      <!-- Fin Lista Numerada -->
    <?php endif; ?>
    ...
    <?php if($mostrar_experto) : ?>
      <!-- Experto -->
        <?php get_template_part('template-parts/especialidades/seccion', 'expertos', array("class" => "marginTop paginaCirugiaGeneral"));?>
      <!-- Fin Experto -->
    <?php endif; ?>
