<?php
/* 
Template Name: Plantilla Especialidad | Neurocirugía
*/ 
...
<?php endif; ?>
    ...
    <?php if($mostrar_hero) : ?>
      <!-- Hero -->
        <?php get_template_part('template-parts/especialidades/seccion', 'hero', array('class' => 'paginaNeurocirugia') );?>
      <!-- Fin Hero -->
    <?php endif; ?>
    ...
    <?php endif; ?>
     ...
     <?php if($mostrar_imagen_texto_cta) : ?>
      <!-- Imagen Texto CTA -->
        <?php get_template_part('template-parts/especialidades/seccion', 'imagen-texto-cta', array('class' =>'paginaNeurocirugia'));?>
    ...
    <?php if($mostrar_targetas_grid) : ?>
      <!-- Targetas Grid -->
        <?php get_template_part('template-parts/especialidades/seccion', 'targetas-grid', array('class' =>'paginaNeurocirugia'));?>
      <!-- Fin Targetas Grid -->
    <?php endif; ?>
