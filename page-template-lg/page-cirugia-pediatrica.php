<?php
/* 
Template Name: Plantilla Especialidad | Cirugia Pediatrica
*/ 
...
<?php endif; ?>
    ...
    <?php if($mostrar_lista_numerada) : ?>
      <!-- Lista Numerada -->
        <?php get_template_part('template-parts/especialidades/seccion', 'lista-numerada',  array('class' => 'paginaCirugiaPediatrica') );?>
      <!-- Fin Lista Numerada -->
    <?php endif; ?>
    ...
    <?php if($mostrar_experto) : ?>
      <!-- Experto -->
        <?php get_template_part('template-parts/especialidades/seccion', 'expertos', array("class" => "paginaCirugiaPediatrica"));?>
      <!-- Fin Experto -->
    <?php endif; ?>
