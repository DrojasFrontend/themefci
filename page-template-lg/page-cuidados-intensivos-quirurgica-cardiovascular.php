<?php
/* 
Template Name: Plantilla Especialidad | Cuidados Intensivos - Quirúrgica Cardiovascular
*/ 
...
<?php endif; ?>
    ...
    <?php if($mostrar_hero) : ?>
      <!-- Hero -->
        <?php get_template_part('template-parts/especialidades/seccion', 'hero', array('class' => 'paginaUCIQuiCardiovascular') );?>
      <!-- Fin Hero -->
    <?php endif; ?>
    ...
    <?php if($mostrar_texto_desc_banner) : ?>
      <!-- Texto Descripcion Banner -->
        <?php get_template_part('template-parts/especialidades/seccion', 'texto-desc-banner', array('class' =>'paginaUCIQuiCardiovascular'));?>
    ...
    <?php 
      get_template_part('template-parts/especialidades/seccion', 'tab-tarjeta-texto-imagen', 
        array(
          'class' => 'paginaUCIQuiCardiovascular',
          'active' => 'UCI Quirúrgica Cardiovascular',
