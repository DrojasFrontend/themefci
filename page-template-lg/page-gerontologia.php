<?php
/* 
Template Name: Plantilla Especialidad | Gerontología
*/ 
...
<?php endif; ?>
    ...
    <?php if($mostrar_texto_imagen_cta) : ?>
      <!-- Texto Imagen CTA -->
        <?php get_template_part('template-parts/especialidades/seccion', 'texto-imagen-cta', array('class' =>'paginaGerontologia'));?>
    ...
    <?php if($mostrar_items_iconos) : ?>
      <!-- Items Iconos -->
        <?php get_template_part('template-parts/especialidades/seccion', 'items-iconos', array('class' => 'paginaGerontologia'));?>
      <!-- Fin Items Iconos -->
    <?php endif; ?>
