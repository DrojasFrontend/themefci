<?php
/* 
Template Name: Plantilla Especialidad | Cuidados Intensivos - Pediatrica Cardiovascular
*/ 
...
<?php endif; ?>
    ...
    <?php if($mostrar_hero) : ?>
      <!-- Hero -->
        <?php get_template_part('template-parts/especialidades/seccion', 'hero', array('class' => 'paginaUCIPedCardiovascular') );?>
      <!-- Fin Hero -->
    <?php endif; ?>
    ...
    <?php 
      get_template_part('template-parts/especialidades/seccion', 'tab-tarjeta-texto-imagen', 
        array(
          'class' => 'paginaUCIPedCardiovascular',
          'active' => 'UCI Pediatrica Cardiovascular',
