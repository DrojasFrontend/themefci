<?php
/* 
Template Name: Plantilla Especialidad | Gastroenterologia Pediatrica
*/ 
...
<?php endif; ?>
    ...
    <?php if($mostrar_hero) : ?>
      <!-- Hero -->
        <?php get_template_part('template-parts/especialidades/seccion', 'hero', array('class' => 'paginaGastroenterologia') );?>
      <!-- Fin Hero -->
    <?php endif; ?>
    ...
    <?php if($mostrar_items_iconos) : ?>
      <!-- Items Iconos -->
        <?php get_template_part('template-parts/especialidades/seccion', 'items-iconos', array('class' => 'paginaGastroenterologia'));?>
      <!-- Fin Items Iconos -->
    <?php endif; ?>

    <?php if($mostrar_texto_imagen_cta_2) : ?>
      <!-- Texto Imagen 2 -->
        <?php get_template_part('template-parts/especialidades/seccion', 'texto-imagen-cta-2', array('class' => 'paginaGastroenterologia') );?>
      <!-- Fin Texto Imagen 2 -->
    <?php endif; ?>
