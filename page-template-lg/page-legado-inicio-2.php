<?php
/**
 * Template Name: Plantilla Legado | Inicio 2
 * 
 * @package FCITheme
...
<!-- CONTENIDO -->
    <main>
      <?php get_template_part('template-parts/legado-2/seccion', 'hero')?>
      <?php get_template_part('template-parts/legado-2/seccion', 'pasos')?>
