<?php
/* 
Template Name: Plantilla Especialidad | Hemodinamia adultos
*/ 
...
<?php endif; ?>
    ...
    <?php if($mostrar_hero) : ?>
      <!-- Hero -->
        <?php get_template_part('template-parts/especialidades/seccion', 'hero', array('class' => 'paginaHemodinamiaAdulto') );?>
      <!-- Fin Hero -->
    <?php endif; ?>
    ...
    <?php if($mostrar_items_iconos) : ?>
      <!-- Items Iconos -->
        <?php get_template_part('template-parts/especialidades/seccion', 'items-iconos', array('class' => 'paginaHemodinamiaAdulto'));?>
      <!-- Fin Items Iconos -->
    <?php endif; ?>
    ...
    <?php if($mostrar_targetas_grid) : ?>
      <!-- Targetas Grid -->
        <?php get_template_part('template-parts/especialidades/seccion', 'targetas-grid', array('class' => 'paginaHemodinamiaAdulto'));?>
      <!-- Fin Targetas Grid -->
    <?php endif; ?>
