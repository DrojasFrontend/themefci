<?php
/**
 * Template Name: Plantilla Trasplantes | Pulmon
 * 
 * @package FCITheme
...
<?php endif; ?>
  ...
  <?php if ($mostrar_tarjetas_carusel) : ?>        
    <!-- Tarjetas Carusel -->    
    <?php get_template_part('template-parts/trasplante/seccion', 'tarjetas-carusel', array('class' => 'paginaPulmon')); ?>        
  ...
  <?php if ($mostrar_imagen_cta) : ?>        
    <!-- Imagen CTA -->      
    <?php get_template_part('template-parts/trasplante/seccion', 'imagen-cta', array('class' => 'paginaPulmon')); ?>        
    <!-- Fin Imagen CTA -->
  <?php endif; ?>    
  ...
  <?php if ($mostrar_soluciones) : ?>        
    <!-- Soluciones -->    
    <?php get_template_part('template-parts/trasplante/seccion', 'soluciones', array('class' => 'paginaPulmon')); ?>        
    <!-- Fin Soluciones -->
  <?php endif; ?>    
  ...
  <?php if ($mostrar_videos) : ?>        
    <!-- Videos -->    
    <?php get_template_part('template-parts/trasplante/seccion', 'videos', array('class' => 'paginaPulmon')); ?>        
    <!-- Fin Videos -->
  <?php endif; ?>
