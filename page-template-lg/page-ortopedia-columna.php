<?php
/* 
Template Name: Plantilla Especialidad | Ortopedia-Columna
*/ 
...
<?php endif; ?>
    ...
    <?php if($mostrar_texto_desc_banner) : ?>
      <!-- Texto Descripcion Banner -->
        <?php get_template_part('template-parts/especialidades/seccion', 'texto-desc-banner', array('class' =>'paginaOrtopediaRodilla'));?>
