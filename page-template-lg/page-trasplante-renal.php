<?php
/**
 * Template Name: Plantilla Trasplante | Renal
 * 
 * @package FCITheme
...
<?php endif; ?>
    ...
    <?php 
      $menu_items = array(
        array('link' => '/trasplante-de-corazon-2', 'name' => 'Corazón adulto', 'class' => ''),
        array('link' => '/trasplante-renal', 'name' => 'Transplante Renal', 'class' => 'active'),
    ...
    <!-- Lista Numerada -->
      <?php get_template_part('template-parts/trasplante/seccion', 'lista-numerada', array('class' => 'trasplanteRenal'));?>
    <!-- Fin Lista Numerada -->
    <?php endif; ?>
    ...
    <?php if($mostrar_bloque_texto) : ?>
      <!-- Bloque Texto -->
      <?php get_template_part('template-parts/trasplante/seccion', 'bloque-texto', array('class' => '') );?>
      <!-- Fin Bloque Texto -->
    <?php endif; ?>
