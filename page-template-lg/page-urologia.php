...
<?php endif; ?>
    ...
    <?php if($mostrar_imagen_texto_cta_invertido) : ?>
      <!-- Imagen Texto CTA -->
        <?php get_template_part('template-parts/especialidades/seccion', 'imagen-texto-cta_invertido', array('class' =>'paginaUrologia'));?>
      <!-- Fin Imagen Texto CTA -->
    <?php endif; ?>
	...
	<?php if($mostrar_acordion) : ?>
		<!-- Accordion -->
			<?php get_template_part('template-parts/especialidades/seccion', 'accordion', array('class' => ''));?>
		<!-- Fin Accordion -->
	<?php endif; ?>
