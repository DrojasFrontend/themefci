<?php
/* 
Template Name: Plantilla Especialidad | Neumología pediátrica
*/ 
...
<?php endif; ?>
    ...
    <?php if($mostrar_texto_desc_banner) : ?>
      <!-- Texto Descripcion Banner -->
        <?php get_template_part('template-parts/especialidades/seccion', 'texto-desc-banner', array('class' =>'paginaNeumologiaPediatrica'));?>
    ...
    <?php if($mostrar_targetas_grid) : ?>
      <!-- Targetas Grid -->
        <?php get_template_part('template-parts/especialidades/seccion', 'targetas-grid', array('class' => ''));?>
      <!-- Fin Targetas Grid -->
    <?php endif; ?>
