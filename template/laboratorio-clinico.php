...
<main>
    ...
    <section class="customSecionLaboratorioClinico customBuscadorTecla pt-48 gradient-1 mt-12">
        <div class="customContainer">
            <h2 class="font-fira-sans fs-1 mb-12 text-center m-0 pb-48">Laboratorio Clinico</h2>
