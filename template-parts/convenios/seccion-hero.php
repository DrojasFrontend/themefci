...
<section class="conveniosHero <?php echo $args['class']; ?>" style="order: <?php echo $posicion; ?>">
  <div class="conveniosHero__fondo desktop">
    <div></div>
    <div>
  ...
  <div class="container--large">
    <div class="conveniosHero__grid">
      <div class="conveniosHero__text">
        <?php if($titulo) : ?>
