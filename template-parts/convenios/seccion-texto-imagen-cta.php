...
<section class="conveniosTextoImagenCTA" style="order: <?php echo $posicion; ?>">
  <div class="container--large">
    <div class="conveniosTextoImagenCTA__flex estilo-1">
      <div class="conveniosTextoImagenCTA__col">
        <div class="conveniosTextoImagenCTA__info">
          <?php if($subtitulo) : ?>
    ...
    <div class="conveniosTextoImagenCTA__col">
      <div class="conveniosTextoImagenCTA__img">
