...
<section class="investigacionesHero">
  <div class="investigacionesHero__fondo desktop">
    <div></div>
    <div>
  ...
  <div class="container--large">
    <div class="investigacionesHero__grid">
      <div class="investigacionesHero__text">
        <?php if($titulo) : ?>
      ...
      <div class="investigacionesHero__img">
        <?php echo generar_imagen_responsive($imagen_id, 'custom-size', $sitename, '');?>
      </div>
    </div>
  </div>
