<section class="customTarjetasGrandes pt-84">
    <div class="customContainer px-0">
        <div class="px-24">
            <h2 class="font-fira-sans fs-2 text-left mb-42">
                Infórmate y participa con LaCardio
            </h2>
        </div>
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="position-relative customHoverLink clickeable">
                        <img class="img-fluid d-none d-lg-block" src="<?php echo get_template_directory_uri(); ?>/images/2025/unete-ala-comunidad.png" alt="Tarjeta grande 1">
                        <img class="img-fluid d-lg-none" src="<?php echo get_template_directory_uri(); ?>/images/2025/unete-ala-comunidad-mobile.png" alt="Tarjeta grande 1">
                        <div class="position-absolute top-0 left-0 w-100 h-100 d-flex flex-column justify-content-end p-24">
                            <p class="subtitulo color--fff mb-12">CARDIOKIDS</p>
                            <h3 class="font-fira-sans fs-4 color--fff mb-18">
                                Únete a la comunidad CardioKids
                            </h3>
                ...
                <div class="swiper-slide">
                    <div class="position-relative customHoverLink clickeable">
                    <img class="img-fluid d-none d-lg-block" src="<?php echo get_template_directory_uri(); ?>/images/2025/conoce-toda-la-actualidad.png" alt="Tarjeta grande 1">
                    <img class="img-fluid d-lg-none" src="<?php echo get_template_directory_uri(); ?>/images/2025/conoce-toda-la-actualidad-mobile.png" alt="Tarjeta grande 1">
                        <div class="position-absolute top-0 left-0 w-100 h-100 d-flex flex-column justify-content-end p-24">
                            <p class="subtitulo color--fff mb-12">NOTICIAS </p>
                            <h3 class="font-fira-sans fs-4 color--fff mb-18">
                                Conoce toda la actualidad en salud
                            </h3>
                            <a href="/noticias/" class="d-flex align-items-center font-sans fs-6 fw-semibold color--fff">
                                <span class="customHover customHover-blanco color--fff">
