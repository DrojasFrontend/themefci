        ...
        <div class="customContainer px-0">
            ...
            <div class="swiper swiperTarjetasGrandes">
                <div class="swiper-wrapper">
                    ...
                    $seccion_tarjeta_cta            = !empty($tarjeta['seccion_tarjeta_cta']) ? $tarjeta['seccion_tarjeta_cta'] : [];
                    $seccion_tarjeta_cta_url        = !empty($seccion_tarjeta_cta['url']) ? esc_attr($seccion_tarjeta_cta['url']) : '';
                    $seccion_tarjeta_cta_title      = !empty($seccion_tarjeta_cta['title']) ? esc_attr($seccion_tarjeta_cta['title']) : '';
                    $seccion_tarjeta_cta_target     = !empty($seccion_tarjeta_cta['target']) ? esc_attr($seccion_tarjeta_cta['target']) : '_blank';
                    ?>
                    <div class="swiper-slide">
                        <div class="position-relative customHoverLink clickeable">
                            ...
                            <div class="position-absolute top-0 left-0 w-100 h-100 d-flex flex-column justify-content-end p-24">
                                ...
                                <?php endif; ?>
                                <?php if ($seccion_tarjeta_cta_url) : ?>
                                    <a href="<?php echo $seccion_tarjeta_cta_url; ?>" target="<?php echo $seccion_tarjeta_cta_target; ?>" class="d-flex align-items-center font-sans fs-6 fw-semibold color--fff" title="<?php echo $seccion_tarjeta_cta_title; ?>">
