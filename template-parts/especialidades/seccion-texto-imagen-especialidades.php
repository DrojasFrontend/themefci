...
<section class="etapaEspecialidadesTextoImagenCTA paddingBottom estilo-2 <?php echo isset($args['class']) ? $args['class'] : ''; ?>" style="order: <?php echo $posicion; ?>">
    <div class="wrapper">
        ...
        <div class="etapaEspecialidadesTextoImagenCTA__col">
        <div class="etapaEspecialidadesTextoImagenCTA__img etapaEspecialidadesRadius">
