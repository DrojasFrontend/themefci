...
<section class="etapaEspecialidadesHero <?php echo isset($args['class']) ? $args['class'] : ''; ?>" style="order: <?php echo $posicion; ?>">
    ...
    <div class="container--large">
        ...
        <div class="etapaEspecialidadesHero__text paddingLeft etapaEspecialidadesHero__textCenter">
            <?php if($titulo) : ?>
