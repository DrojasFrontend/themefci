...
$grupo_hero = get_field('grupo_hero'); // Asegúrate de que esta línea exista para acceder a $grupo_hero
...
// Obtener todas las especialidades únicas (asumiendo que laboratorios también tienen especialidades)
$especialidades = get_unique_especialidades(); // Asegúrate de que esta función esté definida
            ...
            <div class="procedimientoFiltro__enlaces">
              <?php if ($info_subtitulo): ?>
                ...
                <?php foreach ($info_enlaces as $key => $enlace) {
                  ...
                  ?>
                  <a href="<?php echo $url; ?>" target="<?php echo $target; ?>" title="más sobre <?php echo $titulo; ?>">
                    <?php echo $titulo; ?>
          ...
          if ($query->have_posts()): ?>
            <div class="procedimientoFiltro__procedimientos">
              ...
              <div id="procedimiento-detalle">
                <!-- Aquí se cargará el detalle del laboratorio -->
              </div>
            </div>
          <?php else: ?>
    ...
    function initProcedimientoClick() {
      $('.procedimiento').on('click', function () {
        ...
        $.ajax({
          ...
          type: 'POST',
          data: {
            action: 'cargar_detalle_laboratorios_clinicos',
