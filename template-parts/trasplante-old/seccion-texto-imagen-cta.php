...
<section class="etapaTrasplanteTextoImagenCTA <?php echo isset($args['class']) ? $args['class'] : ''; ?>" style="order: <?php echo $posicion; ?>">
  <div class="container--large">
    <div class="etapaTrasplanteTextoImagenCTA__flex estilo-1">
