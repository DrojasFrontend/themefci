...
$fondo          = !empty($grupo_expertos['fondo']) ? $grupo_expertos['fondo'] : "";
...
?>
<section class="trasplanteExpertos <?php echo isset($args['class']) ? $args['class'] : ''; ?> <?php echo $post_count <= 3 ? 'hiden' : ''?>" style="order: <?php echo $posicion; ?>">
  <div class="trasplanteExpertos__fondo" style="background-color: <?php echo $fondo; ?>">
    <div class="container--large">
      <div class="trasplanteExpertos__titulo">
        <?php if ($subtitulo) : ?>
      ...
      <div class="swiper swiperTrasplante">
        <div class="swiper-wrapper">
          ...
          ?>
            <div class="swiper-slide">
              <a href="<?php echo esc_url($perfil_url); ?>"  class="trasplanteExpertos__slide" title="doctor - <?php echo esc_html($nombre); ?>">
                <div class="trasplanteExpertos__img">
                  <img src="<?php echo esc_url($imagen['url']); ?>" alt="<?php echo esc_attr($nombre); ?>">
                </div>
                <div class="trasplanteExpertos__info">
