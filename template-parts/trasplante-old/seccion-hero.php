...
<section class="etapaTrasplanteHero <?php echo isset($args['class']) ? $args['class'] : ''; ?>">
  <div class="etapaTrasplanteHero__fondo desktop">
    <div></div>
    <div>
  ...
  <div class="container--large">
    <div class="etapaTrasplanteHero__grid">
      <div class="etapaTrasplanteHero__text">
        <?php if($titulo) : ?>
      ...
      <div class="etapaTrasplanteHero__img">
        <?php echo generar_imagen_responsive($imagen_id, 'custom-size', $sitename, '');?>
      </div>
    </div>
  </div>
