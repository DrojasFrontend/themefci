...
<div class="citasMedicasAlianzas visibleDesktop">
    <?php if ($alianzas_query->have_posts()) { $group_id = 1; ?>
                        ...
                        <div id="tab<?php echo esc_attr($group_id . '-' . ($index + 1)); ?>" 
                            ...
                            <?php if($alianzas) { ?>
                                <div class="tarjeta__grid">
                                    <?php foreach ($alianzas as $key => $alianza) { 
                                        $logo = $alianza["logo"];
                                                    ...
                                                    <div class="alianzasImagenTexto__info">
                                                        ...
                                                        <?php if($tarjeta_descripcion) : ?>
                                                            ...
                                                            <a href="<?php echo $tarjeta_cta_url; ?>" 
                                                               ...
                                                               target="<?php echo esc_attr($tarjeta_cta_target); ?>" 
