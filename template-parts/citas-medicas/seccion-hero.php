...
<section class="citasMedicasHero <?php echo $args['class']; ?>" style="order: <?php echo $posicion; ?>">
  <div class="citasMedicasHero__fondo desktop">
    <div></div>
    <div>
  ...
  <div class="container--large">
    <div class="citasMedicasHero__grid">
      <div class="citasMedicasHero__text">
        <?php if($titulo) : ?>
      ...
      <div class="citasMedicasHero__img">
        <?php echo generar_imagen_responsive($imagen_id, 'custom-size', $sitename, '');?>
      </div>
    </div>
  </div>
