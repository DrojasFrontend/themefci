          ...
          <select name="especialidad" id="especialidad">
            ...
            <?php 
              ...
              foreach ($especialidades as $especialidad) : 
                $especialidad_formatted = ucwords(strtolower($especialidad)); 
            ?>
              <option value="<?php echo esc_attr(strtolower($especialidad)); ?>" <?php selected($especialidad_seleccionada, strtolower($especialidad)); ?>>
                <?php echo esc_html($especialidad_formatted); ?>
              </option>
            <?php endforeach; ?>
          </select>
