                    ...
                    <div class="sectionServiciosMedicos__grid">
                        ...
                        ?>
                            <div class="sectionServicioMedico">
                                ...
                                <div>
                                    <h2 class="heading--24"><?php echo $nombre; ?></h2>
                                    <?php if($detalle) { ?>
                                    <p class="font-sans heading--18"><?php echo $detalle; ?></p>
                                    <?php } ?>
                                    <a class="sectionServicioMedico__cta heading--18 text-white" href="<?php echo $cta_url; ?>" target="<?php echo $cta_target; ?>"><?php echo $cta_title; ?></a>
                                </div>
                            </div>
                        <?php } ?>
                    </div>
