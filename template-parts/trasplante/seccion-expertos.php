...
?>
<section class="paginaTrasplanteExpertos <?php echo isset($args['class']) ? $args['class'] : ''; ?> <?php echo $post_count <= 3 ? 'hiden' : ''?>" style="order: <?php echo $posicion; ?>">
  <div class="paginaTrasplanteExpertos__fondo">
    <div class="container--large">
      <div class="paginaTrasplanteExpertos__titulo">
        <?php if ($subtitulo) : ?>
      ...
      <div class="swiper swiperTrasplanteExpertos">
        <div class="swiper-wrapper">
          ...
          ?>
            <div class="swiper-slide">
              <a href="<?php echo esc_url($perfil_url); ?>"  class="paginaTrasplanteExpertos__slide" title="doctor - <?php echo esc_html($nombre); ?>">
                <div class="paginaTrasplanteExpertos__img">
                  <img src="<?php echo esc_url($imagen['url']); ?>" alt="<?php echo esc_attr($nombre); ?>">
                </div>
                <div class="paginaTrasplanteExpertos__info">
