...
$titulo       = !empty($grupo_hero['titulo']) ? $grupo_hero['titulo'] : '';
...
<section class="paginaTrasplanteHero <?php echo isset($args['class']) ? $args['class'] : ''; ?>" style="order: <?php echo $posicion; ?>">
  <div class="paginaTrasplanteHero__fondo desktop">
    <div></div>
    <div>
  ...
  <div class="container--large">
    <div class="paginaTrasplanteHero__grid">
      <div class="paginaTrasplanteHero__text">
        <?php if($titulo) : ?>
      ...
      <div class="paginaTrasplanteHero__img">
        <?php echo generar_imagen_responsive($imagen_id, 'custom-size', $sitename, '');?>
      </div>
    </div>
  </div>
